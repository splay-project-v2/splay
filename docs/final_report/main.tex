  ...
  \label{chap:qual}
    ...
    \label{chap:newfeat}
      ...
      \subsection{Topology creation}
        ...
        We wanted to allow the user to use \texttt{XML} directly
...
docker-compose -f docker-compose.prod.yml up -d --scale daemon=7
    ...
    \section{Implementation of Raft in Lua}
      ...
      After the successful easy installation, the real work can start and our
      student will create his own implementation of Raft using the \texttt{Splay}
      library.

      \subsection{Raft election}

        Raft is a consensus algorithm, often used as an alternative to Paxos because
        ...
        During the leader election phase, a unique leader is elected
        ...
        triggers an election, it becomes candidate and requests votes to
...
events.run(function()
    ...
    events.exit()
      ...
      \subsection{First Results}
        ...
        Once he sends the job, he can observes in the logs that a node
...
2019-05-30 08:20:10.0622 (2)  3: RPC Append entry FROM 2.0 Term: 1.0 Entry: null
    ...
    \section{Timeline Animation}
      ...
      logs and allows the user to see the evolution during the job's
      ...
      if a packet is travelling between two nodes and time
      ...
      topology emulation and no crashes) with this tool, we will not clearly see
      ...
      The main reason of this is the lack of latency between nodes. Indeed, without
      ...
      expected), and thus a candidate gets its vote granted really fast (and
    ...
    \section{Robustness of solution}
      ...
      \subsection{Network Topology Emulation}
        ...
        \subsubsection{Network Topology Impact}
          ...
          election and quickly stabilized (one becomes the leader, the others
          ...
          \begin{itemize}
            ...
            He also expects that the communication with daemon 5 always
...
...
      ...
      \subsection{Advanced fault injection}
        ...
        As before, he adds a crash point in the heartbeat function, but with
...
...
      ...
      \subsection{Animation results}
        ...
        Now that the student has tried his Raft election implementation on
        ...
        Note that conflicts rarely happen with 3 candidates because the
        ...
        \begin{figure}[H]
          ...
          \begin{subfigure}{.45\textwidth}
            ...
            \caption{Three candidates for the leader job -> conflict, none becomes the leader, the majority is slipped}
            \label{fig:ele2}
          \end{subfigure}
          \begin{subfigure}{.45\textwidth}
            \centering
          ...
          \begin{subfigure}{.45\textwidth}
            ...
            \caption{The leader (job 4) sending heartbeats to other nodes to avoid a new leader election}
            \label{fig:ele4}
          \end{subfigure}
