on a large% EPL master thesis covers template
    ...
    \section{Bug fix on Daemon and Controller}
      ...
      \subsection{Controller changes}
        ...
        \begin{itemize}
          ...
          daemons was not coherent with the daemon protocol. For example, the
          logs retrieval was buggy because of protocol not coherent between
          the two services. Logs retrieval and creation has be improved to by
...
2019-05-30 08:20:10.0622 (2)  3: RPC Append entry FROM 2.0 Term: 1.0 Entry: null
      ...
      \section{Timeline Animation}
        ...
        Raft election is mainly divided in two states :
        ...
        We cannot notice that the leader election happened, because no
        network topology was given and RPC messages travel instantaneously
        between the nodes. Therefore, the leader election process finishes
        very quickly (<7ms) and it is impossible to capture in the
        visualization tool .
...
...
          ...
          the algorithm (before saving a persistent state, when a vote is granted)
        ...
        \subsection{Animation result}
          ...
          % Animation with crashed


      \section{Buggy code proof}

        A friend of our student sent him a supposedly better code, but he is not
