  ...
  \chapter{Splay Version 2}
    ...
    \section{New features of Splay}
     ...
     these features would be covered.
      ...
      \subsection{Details of the new features}  %TODO: Review - Rewrite

        \subsubsection{Complete Lua editor on the website}  %TODO: Review - Rewrite

        Splay in its first version had a web application with some basic
        features :

        \begin{itemize}
          \item User registration and connexion
          \item Job listing and creation
          \item Logs retrieval
        \end{itemize}


        This web application as explained before was very trivial with
