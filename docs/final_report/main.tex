...
\begin{document}
  ...
  \chapter{Introduction}
    ...
    \section{Learning Distributed Algorithms}
      ...
      to start playing with a real implementation of it to deepend their
      ...
      \begin{itemize}
        ...
        \item This collection of machines need to be set up, each machine has
    ...
    \section{Our Work on Splay}
      ...
      the development of the system, starting from a supposely stable
      ...
      \begin{itemize}
        ...
        \item Enhancing the project with a features designed to provide a
        student with all the necessary environment for an easier and conveniant
      ...
      the problem. Then, a chapter will explain in details all our
...
2019-05-30 08:20:10.0622 (2)  3 : RPC Append entry FROM 2.0 Term : 1.0 Entry : null
      ...
      \section{Timeline Animation}
        ...
        Raft ellection follows this pattern most of the case:

        % TODO illustration no topo, no crash
...
...
          ...
          to observe the behaviour of the Raft election when there is a fault.\\
