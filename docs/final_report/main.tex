...
docker-compose -f docker-compose.prod.yml up -d --scale daemon=7
  ...
  \chapter{Conclusion} % TODO : Modify
    ...
    \section{Improvements} % TODO : Modify
      ...
      \subsection{Refactor of old services} % TODO : Modify
        ...
        \subsubsection{Daemon} % TODO : Modify
          ...
          % TODO problem with toplogy - client socket doesn't take in account !
        ...
        \subsubsection{Controller} % TODO : Modify
