  ...
  \chapter{Introduction}
    ...
    \section{About the Splay Project}
      ...
      \subsection{A first update}
        ...
        Nous sommes donc parvenus à progressivement remettre en état de
