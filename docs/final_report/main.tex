    ...
    \section{Testing and Validation}
      ...
      \subsection{Testing in Web App}
        ...
        \subsubsection{Jest}
          ...
          successfully instantiated among the application, then run a serie
      ...
      \subsection{Testing in Backend}
        ...
        modelization allow us to do model testing.
        ...
        \subsubsection{Code Quality - Rubocop}
          ...
          to many variables instantiations, too many conditional branching
          in the code, ...).
...
...
          ...
          This crash point will only be triggered by the leader (as heartbaet
...
...
          ...
          the algorithm (before saving persistent state, when a vote is granted)
