...
The creation of distributed algorithm is a difficult task, and moreover, it is hard to make code who is reliable. Robustness and correctness of a distributed solution is hard to test with simulation, and manually injection of fault is painful and can take some time. \\
