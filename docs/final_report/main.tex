...
\begin{document}
  ...
  \chapter*{Abstract}
    ...
    This master thesis covers the contributions made on the Splay application
    in order to turn it into an integrated platform for distributed systems
    training and learning.\\
    Splay was initially designed for researchers fo facilitate the testing and
    ...
    The contributions made on Splay are a new web application designed
    ...
    An extensive work of software engineering has also been achieved to
    set up a complete test environment using unit and integration testing
    with continuous integration, a complete and easy to use installation
    script, a total project management recast on Github.
    ...
    \section{Roadmap}
      ...
      \subsection{Changes}
        ...
        \subsubsection{Easy installation}
          ...
          installation. Docker-compose file allows specifying  a
          ...
          However, these docker images were not perfectly built: health checks
