...
-- CRASH POINT 1 2 :RECOVERY 1 : TIME 3
    ...
    \chapter{Use Case} % TODO : Rewrite
      ...
      \section{Installation of Splay} % TODO : Rewrite
...
docker-compose -f docker-compose.prod.yml up -d --scale daemon=7
      ...
      \section{Implementation of Raft in Lua} % TODO : Rewrite
        ...
        \subsection{Creation of the algorithm} % TODO : Rewrite
        ...
        \subsection{First result} % TODO : Rewrite
...
2019-05-30 08:20:10.0622 (2)  3 : RPC Append entry FROM 2.0 Term : 1.0 Entry : null
      ...
      \section{Timeline Animation} % TODO : Rewrite
      ...
      \section{Robustness of solution} % TODO : Rewrite
        ...
        \subsection{Topology settings} % TODO : Rewrite
        ...
        \subsection{Fault injection} % TODO : Rewrite
...
...
      ...
      \section{Buggy code proof} % TODO : Rewrite
