...
\begin{document}
  ...
  \chapter{Introduction}
    ...
    % Se qui existe déjà Emulab, PlanetLab. 

    % Code asynchrone donc difficile sans libraries adapté (Mace, etc)
    ...
    what he learns. Indeed, in order to run a distributed algorithm and observe the result, a
  ...
  % Old one, change for reasons, develpoment backend, CLI, web_app begin
...
\subsection{new features}  
  ...
  % Redistribuate into all chapter 3-5
...
docker-compose -f docker-compose.prod.yml up -d --scale daemon=7
  ...
  \chapter{Conclusion}
    ...
    \section{Improvements}
      ...
      % Our features
      \subsection{Our possible Features improvement}
