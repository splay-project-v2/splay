...
events.run(function()
    ...
    events.exit()
      ...
      \subsection{First Results}
        ...
        Once he sends the job, he can observe in the logs that a node
...
2019-05-30 08:20:10.0622 (2)  3: RPC Append entry FROM 2.0 Term: 1.0 Entry: null
    ...
    \section{Timeline Animation}
      ...
      The main reason for this is the lack of latency between nodes. Indeed, without
      ...
      \subsection{Animation results}
        ...
        \begin{figure}[H]
          ...
          \begin{subfigure}{.45\textwidth}
            ...
            \caption{Three candidates for the leader job -> conflict, none becomes the leader, the majority is split}
            \label{fig:ele2}
          \end{subfigure}
          \begin{subfigure}{.45\textwidth}
            \centering
