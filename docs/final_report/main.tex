  ...
  \label{chap:dev}
    ...
    \section{Project Analysis and Modifications}
      ...
      \subsection{Better User Services}
        ...
        the usage of JWT \cite{JWT} (a token based identification system
    ...
    \section{Backend Development}
      ...
      \subsection{The Choice of Rails}
        ...
        Rails allow to easily develop, besides traditional MVC web
        applications, API-only applications that don't contain all the code
        ...
        made for the testing, Rubocop~\cite{Rubocop} for the linter definitely
        made Rails the right technology to choose for the Backend.
      ...
      \subsection{Centralization of Splay's Backend}
        ...
        \begin{itemize}
          ...
          \item \textbf{Travis}: A continuous integration platform
        ...
        \subsubsection{User Authentication}
          ...
          applied to manage registration through the API, as it needed the JWT
        ...
        \subsubsection{Error Handling}
          ...
          \begin{itemize}
            ...
            in the Ruby language) to catch which errors happen in our
            application:
              \begin{itemize}
    ...
    \section{Web Application Development}
      ...
      \subsection{Choosing the Framework}
        ...
        Cloud Computing course at UCLouvain, we decided to go for VueJS
        instead of React.\\
        ...
        developers.\\
        Vue allowed us to be totally confident into the fact
        ...
        The fact that the framework belongs to the JavaScript ecosystem and is
        ...
        For all those reasons, Vue was the best choice for a
      ...
      \subsection{The new front-end application development}
        ...
        \begin{itemize}
          ...
          bootstrap table.
          \item A second table used for jobs (also fetched from the backend) is also
    ...
    \section{CLI Development}
      ...
      \subsection{Using Python}
        ...
        the relevance of Lua for this application.\\
        ...
        of reaching the server through a HTTP library in Lua.\\
      ...
      \subsection{Developing the CLI}
        ...
        decided to use the \textsc{Click}~\cite{click} library, a perfect
        ...
        \textsc{Click} reassembles all of this and format theoutput of the CLI,
        ...
        Lua lines of code and to obtain two hundred of simple and
      ...
      \subsection{Fault injection}
        ...
        \subsubsection{Leader crashs}
          ...
          \begin{table}[]
            ...
            Topology 3 & 90     & 102    & 102    & 94     & 10     & 398   \\ \hline
            \end{tabular}
          \end{table}
