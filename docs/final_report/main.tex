  ...
  \label{chap:splayteaching}
    ...
    \section{What Splay Offered}
      ...
      \subsection{Application Usage}
        ...
        algorithm (with simple \texttt{print} function calls), containing its % lower case 
  ...
  \label{chap:dev}
    ...
    \section{Web Application Development}
      ...
      \subsection{The new front-end application development}
        ...
        \texttt{Bootstrap} is a real Swiss-army knife among the design framework
  ...
  \label{chap:qual}
    ...
    \section{Testing and Validation}
      ...
      \subsection{Testing in Daemons}
        ...
        called \texttt{Busted}~\cite{busted}. This library allowed elegant unit testing,
        still under development and fully integrated with \texttt{Lua} 5.3.\\
