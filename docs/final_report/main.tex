  ...
  \chapter{Quality Assurance}
    ...
    \chapter{New Features}
      ...
      \section{Fault injection}
        ...
        The fault injection feature (or crash points) is achieved on the daemon
        ...
        daemon was able to handle with precision this crash.\\
        ...
        in the LUA code as a comment. During the job execution phase, the first
        step is to parse the code and gather those crash points to manage the
        crashes.
        ...
        \subsection{Domain Specific Language (DSL)}
          ...
          it, trying to avoid totally crashing the daemon in case of the crash
          points specified by the user were not correct.\\
          ...
          order to keep our error messages right (getting the same line line
          ...
          \begin{itemize}
            ...
            affected nodes separated by a space.
          ...
          number of seconds specified by the user.\\
          ...
          \begin{itemize}
            ...
            the value 5 in a loop means that this loop will execute 5 times
            ...
            encounters the crash point through the code execution.
          \end{itemize}
        ...
        \subsection{Parsing}
          ...
          crash points comments specified by the users are transformed and
          replaced (if no error is found) by a function call containing the
          crash id number. Therefore, when the code executes, the crash function
          ...
          syntax of the crash poin, still crashing the node.\\
          Parsing is done line by line and if any error is found (also error
          about the code itself), the concerned line will be unchanged and
          a warning or error message will be written in the logs.\\
          This feature is fully wrote in LUA using a regex matcher
          \cite{RegexLua}.
        ...
        \subsection{Execution}
          ...
          an OS function. We also have the possibility of sending an exit
          ...
          in order to send messages to another process.\\
...
docker-compose -f docker-compose.prod.yml up -d --scale daemon=7
  ...
  \chapter{Conclusion} % TODO : Modify
    ...
    \section{Improvements} % TODO : Modify

      % Our features
      \subsection{New features improvement} % TODO : Modify

        \subsubsection{Lua editor} % TODO : Modify
        ...
        \subsubsection{Crash point} % TODO : Modify
        ...
        \subsubsection{Topology Creation} % TODO : Modify
      ...
      \subsection{Security aspect} % TODO : Modify
